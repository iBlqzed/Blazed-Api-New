...
declare module "@minecraft/server" {
    interface Entity {
        ...
        /**
         * Get the entity's health (if they have a health component)
        ...
        /**
         * Set the entity's health (if they have a health component)
